"use strict";
const Course_filesResourceAccess = require("../resourceAccess/Course_filesResourceAccess");
const Logger = require("../../../utils/logging");
const { STAFF_ROLE } = require("../Course_filesConstant");
...
async function insert(req) {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      let course_filesData = req.payload;
      //create new user
      let addResult = await Course_filesResourceAccess.insert(course_filesData);
